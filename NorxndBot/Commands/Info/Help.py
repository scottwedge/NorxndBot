...
class Help(commands.Cog):
    ...
    # Help
    @commands.command(name="Help", aliases=["HELP"]) # Basic Information command
    async def help_command(self, ctx):
        ...
        info.add_field(name="?Channels", value="Show server channels and their purpose.")
        info.add_field(name="?StarCode view/use @User", value="View or use someone Star Code.")
        ...
        req.add_field(name='?ServReq "Flood Escape 2" "LINK"', value="Request for add Vip server to list", inline=True)
        ...
        embed = discord.Embed(title="NorxndBot {}".format(self.bot.Version), url="https://github.com/norxnd/norxndbot",description="By NORXND Unname", color = 0xefbf01)
        embed.add_field(name="Fallow @NORXND_Unname on Twitter", value="patreon.com/norxnd", inline=False)
        embed.set_footer(text="Thanks to Piotr Baja, realpython.com, discord.py discord server community and Heroku")
    ...
    async def AdminHelp(self, ctx):
        ...
        embed.set_footer(text="?Log 0 - See bot log(0 - for all logs or number).ONLY FOR ADMINISTRATOR AND ABOVE!!!")
